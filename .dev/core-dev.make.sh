...
# Test command:
# podman run -it --rm -v .:/home/smith/workspace --userns=keep-id --hostname dev-core --name dev-core nvil-core-dev:latest zsh -ic zellij # Pass '--network=none' to test offline
